...
$totalPages = ceil(count($agen) / $dataPerPage);
...
$displayData = array_slice($agen, $startIndex, $dataPerPage);
?>
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="table-responsive table-container fade-in">
            <!-- Form Pencarian -->
            <form action="<?php echo site_url('administrator/l_agen/cari_data'); ?>" method="get"
            ...
            <div class="text-center mt-3">
                <strong>Data Agen Tidak Ditemukan</strong>
            </div>
            <?php else : ?>

            <h3 class="text-center head-er judul"><strong>List Agen Gas Elpiji Garut</strong></h3>
            <!-- Tampilkan jumlah total data -->
            <p class="text-right">Jumlah Data Agen: <?php echo count($agen); ?></p>
    ...
    ?>
                <tr>
                    ...
                    <td class="text-center"><?php echo $t->alamat_agen; ?></td>
                    <td class="text-center"><?php echo $t->pso; ?></td>
                    <td class="text-center"><?php echo $t->nama_perusahaan; ?></td>
                    <td class="text-center"><?php echo $t->jumlah_pangkalan_memilih; ?></td>
                </tr>
                <?php endforeach; ?>
            </table>
