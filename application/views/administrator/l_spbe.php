...
$totalPages = ceil(count($spbe) / $dataPerPage);
...
$displayData = array_slice($spbe, $startIndex, $dataPerPage);
?>
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="table-responsive table-container fade-in">
            <!-- Form Pencarian -->
            <form action="<?php echo site_url('administrator/l_spbe/cari_data'); ?>" method="get"
            ...
            <div class="text-center mt-3">
                <strong>Data SPBE Tidak Ditemukan</strong>
            </div>
            <?php else : ?>
            <h3 class="text-center head-er judul"><strong>List SPBE Garut</strong></h3>
            <p class="text-right">Jumlah Data SPBE: <?php echo count($spbe); ?></p>
            ...
            <table class="table table-bordered table-striped mt-2" style="padding-left: 20px;">
                ...
                <tr>
                    ...
                    <td class="text-center"><?php echo $t->alamat_kantor ?></td>
