       ...
       <div class="container-fluid">
           ...
           <!-- Form Pencarian -->
           <form action="<?php echo site_url('administrator/agen/cari_data'); ?>" method="get"
           ...
           <div class="d-flex mb-3 align-items-center" style="margin-top: 20px;">
               ...
               <?php if (!empty($agen)) : ?>
               <a class="btn btn-sm btn-primary mr-2" href="<?php echo base_url('administrator/agen/print_data')?>">
                   <i class="fas fa-print"></i> Cetak
               </a>
               <?php endif; ?>
               <!-- Button Tambah Data  -->
               <a class="btn btn-sm btn-success" href="<?php echo base_url('administrator/agen/tambah_agen/')?>">
                               ...
                               <td>
                                   <div class="btn-group">
                                       ...
                                       <a class="btn btn-sm btn-primary"
                                           href="<?php echo base_url('administrator/agen/update_agen/'.$t->id_agen)?>">
                                           <i class="fas fa-edit"></i>
                                       </a>
                                       <!-- Delete Data -->
                                       <a onclick="return confirm('Apakah Anda Ingin Menghapusnya??')"
                                           class="btn btn-sm btn-danger"
                                           href="<?php echo base_url('administrator/agen/delete_data2/'.$t->id_agen)?>">
