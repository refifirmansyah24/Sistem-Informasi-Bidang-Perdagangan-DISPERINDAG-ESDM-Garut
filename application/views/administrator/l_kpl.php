...
$totalPages = ceil(count($kpl) / $dataPerPage);
...
$displayData = array_slice($kpl, $startIndex, $dataPerPage);
?>
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="table-responsive table-container fade-in">
            <!-- Form Pencarian -->
            <form action="<?php echo site_url('administrator/l_kpl/cari_data'); ?>" method="get"
            ...
            <div class="text-center mt-3">
                <strong>Data Kios Pupuk Lengkap Tidak Ditemukan</strong>
            </div>
            <?php else : ?>
            <h3 class="text-center head-er judul"><strong>List Kios Pupuk Lengkap Garut</strong></h3>
            <!-- Tampilkan jumlah total data -->
            <p class="text-right">Jumlah Data Kios Pupuk Lengkap: <?php echo count($kpl); ?></p>
            <!-- Tampilkan tabel jika data ditemukan -->
            <table class="table table-bordered table-striped mt-2" style="padding-left: 20px;">
                <tr>
                    <th class="text-center">No</th>
                    <th class="text-center">Nama KPL</th>
                    <th class="text-center">Pemilik</th>
                    <th class="text-center">Alamat</th>
                    <th class="text-center">Kecamatan</th>
                    <th class="text-center">No. HP</th>
                    <th class="text-center">Distributor PT. Pupuk Kujang</th>
                    <th class="text-center">Distributor PT. Petro Kimia Gresik</th>
    ...
    foreach ($displayData as $t) : ?>
                <tr>
                    ...
                    <td class="text-center"><?php echo $t->nama_kpl ?></td>
                    <td class="text-center"><?php echo $t->pemilik ?></td>
                    <td class="text-center"><?php echo $t->alamat ?></td>
                    <td class="text-center"><?php echo $t->kecamatan ?></td>
                    <td class="text-center"><?php echo $t->no_hp ?></td>
                    <td class="text-center"><?php echo $t->dis_1 ?></td>
                    <td class="text-center"><?php echo $t->dis_2 ?></td>
