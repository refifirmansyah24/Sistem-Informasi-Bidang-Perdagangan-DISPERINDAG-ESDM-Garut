        ...
        <table class="table table-bordered table-striped mt-2">
            <thead>
                <tr>
                    ...
                    <th class="text-center"> Kebutuhan BBM (Liter)</th>
                    <th class="text-center"> Durasi Operasi</th>
                    <th class="text-center"> Konsumsi BBM (Liter)</th>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <a onclick="return confirm('Apakah Anda Ingin Menghapusnya??')"
                                ...
                                href="<?php echo base_url('administrator/perpanjangan_rekom/delete_data/'.$data_perpanjangan->id_kebutuhan)?>">
