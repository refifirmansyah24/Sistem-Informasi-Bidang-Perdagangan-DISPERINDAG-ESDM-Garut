       ...
       <div class="container-fluid">
           ...
           <!-- Form Pencarian -->
           <form action="<?php echo site_url('administrator/spbu/cari_data'); ?>" method="get"
           ...
           <div class="d-flex mb-3 align-items-center" style="margin-top: 20px;">
               ...
               <?php if (!empty($spbu)) : ?>
               <a class="btn btn-sm btn-primary mr-2" href="<?php echo base_url('administrator/spbu/print_spbu')?>">
                   <i class="fas fa-print"></i> Cetak
               </a>
               <?php endif; ?>
               <!-- Button Tambah Data  -->
               <a class="btn btn-sm btn-success" href="<?php echo base_url('administrator/spbu/tambah_spbu/')?>">
                               ...
                               <td>
                                   <div class="btn-group">
                                       ...
                                       <a class="btn btn-sm btn-primary"
                                           href="<?php echo base_url('administrator/spbu/update_spbu/'.$t->id_spbu)?>">
                                           <i class="fas fa-edit"></i>
                                       </a>
                                       <!-- Delete Data -->
                                       <a onclick="return confirm('Apakah Anda Ingin Menghapusnya??')"
                                           class="btn btn-sm btn-danger"
                                           href="<?php echo base_url('administrator/spbu/delete_data/'.$t->id_spbu)?>">
