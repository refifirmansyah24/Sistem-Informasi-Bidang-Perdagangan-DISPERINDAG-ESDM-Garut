    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center"
                href="http://localhost/disperindag/index.php/administrator/dashboard">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link active" href="http://localhost/disperindag/index.php/administrator/dashboard">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePerdagangan" class="collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url('administrator/tdg')?>">Tanda Daftar
                            Gudang</a>
                        <a class="collapse-item" href="<?php echo base_url('administrator/pengajuan_rekom')?>">Pengajuan
                            Rekomendasi</a>
                        <a class="collapse-item" href="<?php echo base_url('administrator/rekom_solar')?>">Riwayat
                            Rekomendasi</a>
                        <a class="collapse-item" href="<?php echo base_url('administrator/spbu')?>">SPBU</a>
                        <a class="collapse-item" href="<?php echo base_url('administrator/spbe')?>">SPBE</a>
                        <a class="collapse-item" href="<?php echo base_url('administrator/agen')?>">Agen</a>
                        <a class="collapse-item" href="<?php echo base_url('administrator/pangkalan')?>">Pangkalan</a>
                        <a class="collapse-item" href="<?php echo base_url('administrator/kpl')?>">Kios Pupuk
                            Lengkap</a>
                    </div>
                </div>
            </li>
