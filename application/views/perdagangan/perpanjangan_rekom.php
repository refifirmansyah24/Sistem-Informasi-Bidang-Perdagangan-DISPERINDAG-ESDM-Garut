                             ...
                             <td>
                                 <div class="btn-group">
                                     ...
                                     <a class="btn btn-sm btn-primary"
                                         href="<?php echo base_url('perdagangan/pengajuan_rekom/tambah_pengajuan_lama/'.$r->id_rekomendasi)?>">
                                     ...
                                     <a class="btn btn-sm btn-primary"
                                         href="<?php echo base_url('perdagangan/Cetakrekom/exportToWord/' . $r->id_rekomendasi) ?>">
