...
<body>
    <div class="surat-body">
        ...
        <div class="garis-bawah"></div>
        <h3 class="text-center judul-tanda-daftar"><strong>Data Kios Pupuk Lengkap</strong></h3>
        <div class="table-responsive table-container size-text">
