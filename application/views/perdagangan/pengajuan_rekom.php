 ...
 <div class="container-fluid">
     ...
     <!-- Form Pencarian -->
     <form action="<?php echo site_url('perdagangan/pengajuan_rekom/cari_pengajuan'); ?>" method="get"
     ...
     <div class="d-flex mb-3 align-items-center" style="margin-top: 20px;">
         ...
         <a class="btn btn-sm btn-success"
             href="<?php echo base_url('perdagangan/pengajuan_rekom/tambah_peng_solar/')?>">
                             ...
                             <td>
                                 <div class="btn-group">
                                     ...
                                     <a class="btn btn-sm btn-primary"
                                         href="<?php echo base_url('perdagangan/perpanjangan_rekom/tambah_perpanjangan/'.$r->id_rekomendasi)?>">
                                         <i class="fas fa-plus"></i>
                                     </a>
                                     <!-- Tambah Perpanjangan -->
                                     <a class="btn btn-sm btn-primary"
                                         href="<?php echo base_url('perdagangan/pengajuan_rekom/update_pengajuan/'.$r->id_rekomendasi)?>">
                                         <i class="fas fa-edit"></i>
                                     </a>
                                     <!-- Delete Data -->
                                     <a onclick="return confirm('Apakah Anda Ingin Menghapusnya??')"
                                         class="btn btn-sm btn-danger"
                                         href="<?php echo base_url('perdagangan/pengajuan_rekom/delete_data/'.$r->id_rekomendasi)?>">
                                         <i class="fas fa-trash"></i>
                                     </a>
                                     <a class="btn btn-sm btn-primary"
                                         href="<?php echo base_url('perdagangan/Cetakrekom/inputNomorSurat/' . $r->id_rekomendasi) ?>">
                                         <i class="fas fa-print"></i>
                                     </a>
                                     <a class="btn btn-sm btn-success"
                                         href="<?php echo base_url('perdagangan/perpanjangan_rekom/rincian_perpanjangan/'.$r->id_rekomendasi)?>">
