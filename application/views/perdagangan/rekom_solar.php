...
<div class="container-fluid">
    ...
    <form method="get" action="<?php echo base_url('perdagangan/rekom_solar') ?>">
    ...
    <a class="btn btn-sm mb-3 btn-primary" href="<?php echo base_url('perdagangan/rekom_solar/print_riwayat')?>">
