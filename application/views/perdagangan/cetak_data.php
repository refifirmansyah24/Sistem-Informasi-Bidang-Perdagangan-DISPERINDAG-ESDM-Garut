...
<body>
    <div class="surat-body">
        ...
        <div class="garis-bawah"></div>
        <h3 class="text-center judul-tanda-daftar"><strong>Data Agen</strong></h3>
        <div class="table-responsive table-container">
            <table class="table table-bordered table-striped mt-2">
                ...
                <?php
                $no = 1;
                $totalPangkalan = 0; // Initialize totalPangkalan
                foreach ($agen2 as $t) : ?>
                <tr>
                    <td><?php echo $no++ ?></td>
                ...
                <?php 
                $totalPangkalan += $t->jumlah_pangkalan_memilih;
                endforeach; ?>
                <tr>
                    <td colspan="5" class="text-right"><strong>Total</strong></td>
                    <td><?php echo $totalPangkalan ?></td>
                    <td></td>
                </tr>
            </table>
        </div>
