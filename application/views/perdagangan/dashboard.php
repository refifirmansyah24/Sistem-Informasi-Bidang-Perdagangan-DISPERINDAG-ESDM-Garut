                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                ...
                                <a href="<?php echo base_url('perdagangan/tdg'); ?>" class="text-primary">
                                    Tanda Daftar Gudang
                                </a>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                <!-- Menggunakan tag <a> untuk membuat tautan ke halaman pengajuan_rekom -->
                                <a href="<?php echo base_url('perdagangan/pengajuan_rekom'); ?>" class="text-primary">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                <!-- Menggunakan tag <a> untuk membuat tautan ke halaman pengajuan_rekom -->
                                <a href="<?php echo base_url('perdagangan/spbu'); ?>" class="text-primary">
                                    SPBU
                                </a>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                <!-- Menggunakan tag <a> untuk membuat tautan ke halaman pengajuan_rekom -->
                                <a href="<?php echo base_url('perdagangan/spbe'); ?>" class="text-primary">
                                    SPBE
                                </a>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                <!-- Menggunakan tag <a> untuk membuat tautan ke halaman pengajuan_rekom -->
                                <a href="<?php echo base_url('perdagangan/agen'); ?>" class="text-primary">
                                    Agen
                                </a>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                <!-- Menggunakan tag <a> untuk membuat tautan ke halaman pengajuan_rekom -->
                                <a href="<?php echo base_url('perdagangan/pangkalan'); ?>" class="text-primary">
                                    Pangkalan
                                </a>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                <!-- Menggunakan tag <a> untuk membuat tautan ke halaman pengajuan_rekom -->
                                <a href="<?php echo base_url('perdagangan/kpl'); ?>" class="text-primary">
                                    Kios Pupuk Lengkap
                                </a>
                            </div>
                        </div>
