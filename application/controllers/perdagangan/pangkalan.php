...
public function index(){
    ...
    $this->load->view('perdagangan/pangkalan', $data);
...
public function tambah_pangkalan()
{
    ...
    $this->load->view('templates_perdagangan/header', $data);
    $this->load->view('templates_perdagangan/sidebar');
    $this->load->view('perdagangan/tambah_pangkalan', $data);
    $this->load->view('templates_perdagangan/footer');
}
...
{ 
    ...
    if($this->form_validation->run() == FALSE) { 
        ...
        $this->Spbu_model->insert_data($data, 'pangkalan');
         ...
         redirect('perdagangan/pangkalan');
...
public function update_pangkalan($id)
{
    ...
    $this->load->view('templates_perdagangan/header', $data);
    $this->load->view('templates_perdagangan/sidebar');
    $this->load->view('perdagangan/update_pangkalan', $data);
    $this->load->view('templates_perdagangan/footer');
}
...
public function print_pangkalan()
{
    ...
    $this->load->view('templates_perdagangan/header', $data);
    $this->load->view('templates_perdagangan/sidebar');
    $this->load->view('perdagangan/cetak_pangkalan', $data);
    $this->load->view('templates_perdagangan/footer');
}
