...
public function index(){
    ...
    $this->load->view('perdagangan/kpl', $data);
...
public function tambah_kpl()
{
    ...
    $this->load->view('templates_perdagangan/header', $data);
    $this->load->view('templates_perdagangan/sidebar');
    $this->load->view('perdagangan/tambah_kpl', $data);
    $this->load->view('templates_perdagangan/footer');
}
...
public function update_kpl($id)
{
    ...
    $this->load->view('templates_perdagangan/header', $data);
    $this->load->view('templates_perdagangan/sidebar');
    $this->load->view('perdagangan/update_kpl', $data);
    $this->load->view('templates_perdagangan/footer');
}
...
public function delete_data($id)
       ...
       public function print_kpl()
       {
           ...
           $this->load->view('templates_perdagangan/header', $data);
           $this->load->view('templates_perdagangan/sidebar');
           $this->load->view('perdagangan/cetak_kpl', $data);
           $this->load->view('templates_perdagangan/footer');
       }
