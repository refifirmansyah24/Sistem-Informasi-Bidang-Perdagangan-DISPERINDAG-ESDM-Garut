...
public function index(){
    ...
    $this->load->view('perdagangan/tdg', $data);
...
public function tambah_tdg()
{
    ...
    $this->load->view('templates_perdagangan/header', $data);
    $this->load->view('templates_perdagangan/sidebar');
    $this->load->view('perdagangan/tambah_tdg', $data);
    $this->load->view('templates_perdagangan/footer');
}
...
public function update_tdg($id)
{
    ...
    $this->load->view('templates_perdagangan/header', $data);
    $this->load->view('templates_perdagangan/sidebar');
    $this->load->view('perdagangan/update_tdg', $data);
    $this->load->view('templates_perdagangan/footer');
}
...
public function delete_data($id)
       ...
       public function print_tdg()
       {
           ...
           $this->load->view('templates_perdagangan/header', $data);
           $this->load->view('templates_perdagangan/sidebar');
           $this->load->view('perdagangan/cetak_tdg', $data);
           $this->load->view('templates_perdagangan/footer');
       }
