...
if ($this->session->userdata('level') === 'Admin Perdagangan') {
        ...
        $this->load->view('perdagangan/rekom_solar', $data);
    ...
    public function tambah_data_solar()
    {
        ...
        $this->load->view('templates_perdagangan/header', $data);
        $this->load->view('templates_perdagangan/sidebar');
        $this->load->view('perdagangan/tambah_data_solar', $data);
        $this->load->view('templates_perdagangan/footer');
    }
    ...
    { 
        ...
        if($checking_insert)
        {
            redirect('perdagangan/rekom_solar');
        }
        else{
            redirect('perdagangan/rekom_solar');
        }
    ...
    public function print_data($id_rekomendasi)
{
    // Load model atau ambil data dari database berdasarkan $id_rekomendasi
    $data['rekomendasi'] = $this->rekom_solar_model->get_data_by_id($id_rekomendasi); // Ganti dengan model dan metode yang sesuai
    
    // Load view cetak_data.php dan kirimkan data
...
public function print_riwayat()
{
    ...
    $this->load->view('templates_perdagangan/header', $data);
    $this->load->view('templates_perdagangan/sidebar');
        $this->load->view('perdagangan/cetak_riwayat', $data);
        $this->load->view('templates_perdagangan/footer');
    }
