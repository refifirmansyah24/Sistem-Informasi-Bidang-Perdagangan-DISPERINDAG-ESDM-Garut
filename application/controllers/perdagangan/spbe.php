...
public function tambah_spbe()
{
    ...
    $this->load->view('templates_perdagangan/header', $data);
    $this->load->view('templates_perdagangan/sidebar');
    $this->load->view('perdagangan/tambah_spbe', $data);
    $this->load->view('templates_perdagangan/footer');
}
...
public function update_spbe($id)
{
    ...
    $this->load->view('templates_perdagangan/header', $data);
    $this->load->view('templates_perdagangan/sidebar');
    $this->load->view('perdagangan/update_spbe', $data);
    $this->load->view('templates_perdagangan/footer');
}
...
public function delete_data($id)
       ...
       public function print_spbe()
       {
           ...
           // Load view cetak_data.php and pass the data
            $this->load->view('templates_perdagangan/header', $data);
            $this->load->view('templates_perdagangan/sidebar');
           $this->load->view('perdagangan/cetak_spbe', $data);
            $this->load->view('templates_perdagangan/footer');
       }
