...
public function index(){
    ...
    $this->load->view('Administrator/spbu', $data);
...
public function tambah_spbu()
{
    ...
    $this->load->view('templates_administrator/header', $data);
    $this->load->view('templates_administrator/sidebar');
    $this->load->view('administrator/tambah_spbu', $data);
    $this->load->view('templates_administrator/footer');
}
...
public function update_spbu($id)
{
    ...
    $this->load->view('templates_administrator/header', $data);
    $this->load->view('templates_administrator/sidebar');
    $this->load->view('administrator/update_spbu', $data);
    $this->load->view('templates_administrator/footer');
}
       ...
       public function print_spbu()
{
    ...
    $this->load->view('templates_administrator/header', $data);
    $this->load->view('templates_administrator/sidebar');
    $this->load->view('administrator/cetak_spbu', $data);
    $this->load->view('templates_administrator/footer');
}
