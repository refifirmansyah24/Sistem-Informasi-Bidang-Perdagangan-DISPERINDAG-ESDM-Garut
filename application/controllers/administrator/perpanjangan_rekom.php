...
class Perpanjangan_rekom extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('Administrator/perpanjangan_rekom', $data);
    ...
    $this->load->view('templates_administrator/header', $data);
    $this->load->view('templates_administrator/sidebar');
    $this->load->view('administrator/tambah_perpanjangan', $data);
    $this->load->view('templates_administrator/footer');
    }
...
public function rincian_perpanjangan($id){ 
    ...
    $this->load->view('templates_administrator/header', $data);
    $this->load->view('templates_administrator/sidebar');
    $this->load->view('Administrator/rincian_perpanjangan', $data);
    $this->load->view('templates_administrator/footer');
