...
public function index(){
    ...
    $this->load->view('administrator/agen', $data);
...
public function tambah_agen()
{
    ...
    $this->load->view('templates_administrator/header', $data);
    $this->load->view('templates_administrator/sidebar');
    $this->load->view('administrator/tambah_agen', $data);
    $this->load->view('templates_administrator/footer');
}
...
public function update_agen($id)
{
    ...
    $this->load->view('templates_administrator/header', $data);
    $this->load->view('templates_administrator/sidebar');
    $this->load->view('administrator/update_agen', $data);
    $this->load->view('templates_administrator/footer');
}
...
public function print_data()
{
    ...
    $this->load->view('templates_administrator/header', $data);
    $this->load->view('templates_administrator/sidebar');
    $this->load->view('administrator/cetak_data', $data);
    $this->load->view('templates_administrator/footer');
}
